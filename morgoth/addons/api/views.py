...
class AddonGroupViewSet(ModelViewSet):
    ...
    def sync(self, request, *args, **kwargs):
        ...
        balrog.request('rules', method='POST', data={
            ...
            'channel': group.channel_name, 'version': group.browser_version,
            'mapping': group.name, 'comment': 'Generated by Morgoth.'})

        balrog.request('rules', method='POST', data={
            'priority': 1000, 'backgroundRate': 100, 'product': 'SystemAddons',
            'channel': group.channel_name, 'version': group.no_update_version,
            'mapping': 'SystemAddons-no-update', 'comment': 'Generated by Morgoth.'})
